...
def info_page():
    ...
    "UPDATE cleanupinfo SET first_name = %s, last_name = %s, state = %s, postal_code = %s, phone_number = %s, organization = %s, email = %s, clean_up_event = %s, years = %s, activity_location = %s, activity_type = %s, environmental_type = %s WHERE id = %s",
            ...
            sdg14_check = tk.Checkbutton(
                information_frame,
                text="SDG 14: " + sdg_titles[14],
                font=("Helvetica", 11),
                background="#9DC4E5",
                fg="#FFFFFF",
                variable=sdg14,
            ...
            sdg14_check.grid(row=5, column=1, padx=10, pady=10, sticky=tk.W)
        ...
        check_window.iconbitmap(
            r"C:/Users/Justmyr Gutierrez\Downloads/IT222-CleanUp-Drive-Registration-IS-main/clean_up_drive/ocean.ico"
        )
    ...
    background = ImageTk.PhotoImage(
        file="C:/Users/Justmyr Gutierrez\Downloads/IT222-CleanUp-Drive-Registration-IS-main/clean_up_drive/infopage.png"
    )
...
bgImage = ImageTk.PhotoImage(
    file="C:/Users/Justmyr Gutierrez\Downloads/IT222-CleanUp-Drive-Registration-IS-main/clean_up_drive/signinpage.png"
)
...
openeye = PhotoImage(
    file="C:/Users/Justmyr Gutierrez\Downloads/IT222-CleanUp-Drive-Registration-IS-main/clean_up_drive/openeye.png"
)
eyeButton = Button(
    login_window,
    image=openeye,
...
menuPhoto = PhotoImage(
    file=r"C:/Users/Justmyr Gutierrez\Downloads/IT222-CleanUp-Drive-Registration-IS-main/clean_up_drive/menu3.png"
)
menuButton = Button(
